...
class Grapher(object):
    def __init__(self, dataset_dir):
        ...
        self.entity2id = json.load(open(os.path.join(dataset_dir, "entity2id.json")))
        self.relation2id_old = json.load(open(os.path.join(dataset_dir, "relation2id.json")))
        ...
        for relation in self.relation2id_old:
            ...
            counter += 1
        self.ts2id = json.load(open(os.path.join(dataset_dir, "ts2id.json")))
        ...
        self.train_idx = self.create_store("train_lexical.txt")
        self.valid_idx = self.create_store("valid_lexical.txt")
        self.test_idx = self.create_store("test_lexical.txt")
